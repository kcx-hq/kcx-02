...
const DASHBOARD_ROUTE_REGEX =
  /^\/dashboard(?:\/(?:overview|cfo-dashboard|cost(?:\/(?:explorer|history))?|cost-explorer|ec2(?:\/(?:explorer|volumes|performance|optimization|cost|usage|instance-hours|anomaly-detection))?|s3(?:\/(?:cost|usage)(?:\/bucket\/[^/?#]+)?)?|resources|allocation|optimization|anomalies-alerts|budget|report|inventory(?:\/aws(?:\/ec2(?:\/(?:instances|volumes|snapshots))?)?)?))?$/
