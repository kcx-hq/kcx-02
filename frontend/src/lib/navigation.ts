...
const STATIC_ROUTES = [
  ...
  "/client/users",
  "/client/organization/users-roles",
  "/client/actions",
  "/client/profile",
  "/schedule-demo",
  "/login",
...
const LEGACY_ROUTE_REDIRECTS: Record<string, StaticRoute> = {
  ...
  "/support/ticket-management": "/client/support/tickets",
  "/support/meetings": "/client/support/schedule-call",
  "/organization/users-roles": "/client/users",
  "/client/support/ticket-management": "/client/support/tickets",
  "/client/support/meetings": "/client/support/schedule-call",
  "/client/organization/users-roles": "/client/users",
