...
function HeaderIconTooltip({ label }: { label: string }) {
  return (
    <span className="pointer-events-none absolute left-1/2 top-[calc(100%+0.65rem)] z-50 -translate-x-1/2 whitespace-nowrap rounded-none border border-[rgba(162,188,178,0.38)] bg-[rgba(18,30,31,0.98)] px-2.5 py-1.5 text-xs font-medium text-[rgba(232,243,238,0.95)] opacity-0 shadow-[0_10px_26px_rgba(7,15,15,0.34)] transition duration-150 group-hover:opacity-100 group-focus-within:opacity-100">
      {label}
    </span>
  )
}
...
export function ClientTopNavbar({
  ...
  const navIconButtonClass =
    "relative h-10 rounded-none border border-[rgba(160,173,183,0.52)] bg-[#f3f6f5] px-3 text-[color:#4a5d69] transition duration-200 hover:border-[rgba(127,147,160,0.66)] hover:bg-[#e9efee] hover:text-[color:#1f3340]"
      ...
      <div className="mx-auto flex h-16 w-full items-center justify-between gap-4 px-4 sm:px-[22px]">
        <div className="flex min-w-0 flex-1 items-center gap-4">
          {onOpenSidebar ? (
              <Button
                ...
                className="h-9 rounded-none border border-[rgba(160,173,183,0.52)] bg-[#f3f6f5] px-2 text-[color:#4a5d69] hover:bg-[#e9efee] hover:text-[color:#1f3340] lg:hidden"
        ...
        <div className="flex shrink-0 items-center gap-3">
          ...
          <div className="relative hidden xl:block" ref={announcementsRef}>
            <div className="group relative">
              ...
              >
                ...
                {unreadAnnouncementsCount > 0 ? (
                  <span className="ml-1 inline-flex min-w-[1.2rem] items-center justify-center rounded-none border border-[rgba(170,68,68,0.5)] bg-[linear-gradient(180deg,#ff9388_0%,#e66f64_100%)] px-1.5 py-0.5 text-[10px] font-semibold leading-none text-[rgba(255,247,246,0.96)] shadow-[0_4px_10px_rgba(192,67,55,0.35)]">
            ...
            {announcementsOpen ? (
              <div className="absolute right-0 top-12 z-50 w-[360px] rounded-none border border-[rgba(163,189,179,0.38)] bg-[rgba(17,28,29,0.97)] p-3 shadow-[0_16px_36px_rgba(5,11,11,0.35)] backdrop-blur-md">
                ...
                {isAnnouncementsLoading ? (
                  <div className="rounded-none border border-[rgba(163,189,179,0.22)] bg-[rgba(221,236,230,0.04)] p-3 text-sm text-[rgba(213,228,221,0.82)]">
                    Loading announcements...
                  </div>
                ) : null}

                {!isAnnouncementsLoading && announcementsError ? (
                  <div className="rounded-none border border-[rgba(240,133,133,0.32)] bg-[rgba(255,132,132,0.09)] p-3 text-sm text-[rgba(255,220,220,0.94)]">
                ...
                {!isAnnouncementsLoading && !announcementsError && announcements.length > 0 ? (
                  <div className="max-h-[320px] space-y-2 overflow-auto pr-1">
                    {announcements.map((announcement) => (
                      <div
                        key={announcement.id}
                        className="rounded-none border border-[rgba(163,189,179,0.25)] bg-[rgba(221,236,230,0.06)] p-3"
                      >
          ...
          >
            <div className="group relative">
              <Button
                ...
                className={cn(
                  "h-10 rounded-none border border-[rgba(160,173,183,0.52)] bg-[#f3f6f5] px-2 text-[color:#4a5d69] transition duration-200 hover:border-[rgba(127,147,160,0.66)] hover:bg-[#e9efee] hover:text-[color:#1f3340]",
                  menuOpen
                    ? "border-[rgba(104,150,134,0.7)] bg-[color:#e5f1ec] text-[color:#163039]"
                    : ""
                )}
              ...
              >
                ...
                <span className="flex h-7 w-7 items-center justify-center rounded-none bg-[color:#e6eeeb] text-sm font-semibold text-[color:#2f4a50]">
            ...
            {menuOpen ? (
              <div
                role="menu"
                className="absolute right-0 top-full z-50 w-[290px] rounded-none border border-[rgba(163,189,179,0.38)] bg-[rgba(17,28,29,0.97)] p-3 shadow-[0_16px_36px_rgba(5,11,11,0.35)] backdrop-blur-md"
              >
                <div className="rounded-none border border-[rgba(163,189,179,0.25)] bg-[rgba(221,236,230,0.06)] p-3">
                  ...
                  <div className="mt-2 flex items-center gap-2 text-[11px] text-[rgba(196,218,208,0.85)]">
                    <span className="rounded-none border border-[rgba(167,197,186,0.45)] px-1.5 py-0.5">{roleLabel}</span>
                    <span className="rounded-none border border-[rgba(167,197,186,0.45)] px-1.5 py-0.5">{orgName}</span>
                  </div>
                </div>
                ...
                <div className="mt-3 space-y-1">
                  <a
                    ...
                    className="flex items-center justify-between rounded-none px-2.5 py-2 text-sm text-[rgba(228,239,234,0.9)] transition-colors hover:bg-[rgba(162,193,181,0.12)] hover:text-white"
                  >
                ...
                <div className="mt-3 border-t border-[rgba(163,189,179,0.28)] pt-2">
                  <button
                    ...
                    className="flex w-full items-center gap-2 rounded-none px-2.5 py-2 text-left text-sm font-medium text-[rgba(255,220,220,0.94)] transition-colors hover:bg-[rgba(255,120,120,0.12)] hover:text-white"
                  >
