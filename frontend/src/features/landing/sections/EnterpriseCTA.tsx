      ...
      <div className="kcx-container relative z-10 w-full">
        <div className="grid gap-10 sm:gap-12 lg:grid-cols-[minmax(0,1.15fr)_minmax(0,0.85fr)] lg:items-center">
          ...
          <Reveal className="relative" delay={0.1}>
            ...
            <p className="inline-flex items-center gap-2 rounded-xl border border-[rgba(118,180,160,0.42)] bg-[rgba(238,248,244,0.88)] px-3.5 py-2 text-[11px] font-semibold uppercase tracking-[0.13em] text-[#286a56] shadow-[0_2px_6px_rgba(15,23,42,0.04)]">
            ...
            <div className="mt-5 space-y-3">
              {ctaRows.map((row) => (
                <div
                  key={row}
                  className="flex items-start gap-3 rounded-xl border border-[rgba(123,187,167,0.34)] bg-[linear-gradient(120deg,rgba(255,255,255,0.88),rgba(248,253,250,0.72))] px-4 py-3.5 shadow-[0_2px_6px_rgba(15,23,42,0.04)] backdrop-blur-[2px] transition-all duration-300 hover:-translate-y-0.5 hover:border-[rgba(94,170,146,0.52)] hover:shadow-[0_8px_20px_rgba(15,23,42,0.08)] sm:px-5"
                >
        ...
        <Reveal delay={0.14} className="mt-7 flex flex-col gap-3 sm:hidden">
          ...
          <a
            href="#"
            className="inline-flex w-full items-center justify-center gap-1.5 rounded-xl border border-[rgba(88,145,125,0.36)] bg-white/80 px-5 py-3.5 text-[0.9rem] font-semibold text-[#205444] transition-all duration-300 hover:-translate-y-0.5 hover:bg-white"
          >
            Explore Platform
