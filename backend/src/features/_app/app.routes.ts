...
import ec2CostExplorerV2Routes from "../ec2/explorer-cost-v2/ec2-cost-explorer.routes.js";
import ec2UsageExplorerV2Routes from "../ec2/explorer-usage-v2/ec2-usage-explorer.routes.js";
import ec2DataTransferExplorerV2Routes from "../ec2/explorer-data-transfer-v2/ec2-data-transfer-explorer.routes.js";
...
router.use(ec2CostExplorerV2Routes);
router.use(ec2UsageExplorerV2Routes);
router.use(ec2DataTransferExplorerV2Routes);
